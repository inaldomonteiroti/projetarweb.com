 ...
 */
add_filter( 'woocommerce_add_to_cart_fragments', 'projetarshop_woocommerce_header_add_to_cart_fragment' );

function projetarshop_woocommerce_header_add_to_cart_fragment( $fragments ) {
	global $woocommerce;
